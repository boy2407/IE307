...
export default function Modal_v1() {
    const [flower, setflower] = useState('');
    const [modalVisible, setModalVisible] = useState(false);
    const choose = (chooseflower) => {
        setflower(chooseflower);
            ...
            <Modal
                ...
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        <Text style={styles.modalText}>{flower.tenhoa}</Text>
                        <Image source={flower.hinh} style={styles.image} ></Image>
                        <Text style={styles.modalText}>Giá Bán: {flower.dongia} VNĐ</Text>
                        <Pressable 
