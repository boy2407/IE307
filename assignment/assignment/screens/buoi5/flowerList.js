...
export default function FlowerList({TypeFlower,setModalVisible,setFlowerDetail}) {
  ...
  function filtered(hoa) {
    return hoa.tenloai == TypeFlower.tenloai;
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.containerFlowerList}>
        ...
        <Text style={styles.title}>{TypeFlower.tenloai}</Text>

        <FlatList data={filteredFlower}
          renderItem={({ item }) =>
